...
function createNewChart() {
    ...
    // chart_group.selectAll('whatever')
    // .data(data_ready)
    // .enter()
    // .append('path')
    // .attr('d', d3.arc()
    ...
    .on('end', function() {
        ...
        .on("mouseover", function(d, i) {
            d3.select(this).transition('fillColor').duration(50).style('fill', 'orange')
            var x_var = d.key;
            var value = d.value;
        ...
        .on("mouseout", function(d) {
            d3.select(this).transition('fillColor').duration(50).style('fill', 'LightGrey')
            hideTooltip();
